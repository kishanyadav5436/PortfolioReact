...
import { Menu, X, FileCode, Terminal, Download, Sparkles } from 'lucide-react';
    ...
    >
        ...
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-code text-emerald-400 flex items-center gap-1 -mt-1">
          ...
          {/* Desktop Nav Tabs (IDE File Tabs Style) */}
          <nav className="hidden lg:flex items-center bg-slate-900/80 p-1.5 rounded-xl border border-slate-800/80 font-code text-xs">
            {navItems.map((item) => {
          ...
          <div className="hidden md:flex items-center gap-3">
            <a
              ...
              download
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg font-code text-xs font-semibold text-slate-200 bg-slate-800/80 border border-slate-700/80 hover:bg-slate-700/80 hover:border-cyan-500/50 hover:text-cyan-300 transition-all duration-200 shadow-sm"
            >
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg font-code text-xs font-semibold text-slate-950 bg-gradient-to-r from-cyan-400 to-blue-500 hover:from-cyan-300 hover:to-blue-400 transition-all duration-200 shadow-md shadow-cyan-500/25 group"
            >
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-[#090d16]/95 backdrop-blur-xl border-b border-slate-800 px-4 pt-3 pb-6 space-y-2 mt-3 animate-fadeIn">
          <div className="font-code text-xs text-slate-400 px-3 py-1 flex items-center justify-between border-b border-slate-800/80 mb-2">
            <span>EXPLORER</span>
          ...
          <div className="pt-3 flex flex-col gap-2">
            <a
              href="#contact"
              onClick={() => setMobileMenuOpen(false)}
              className="w-full text-center py-2.5 rounded-lg font-code text-xs font-semibold text-slate-950 bg-cyan-400"
            >
              Contact Me
            </a>
          </div>
