            ...
            >
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                {category.skills.map((skill, idx) => (
                  <div
                    key={idx}
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-950/80 border border-slate-800 font-code text-xs text-slate-200 font-medium hover:text-cyan-300 hover:border-cyan-500/40 transition-colors"
                  >
