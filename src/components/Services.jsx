      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <a
                  href="#contact"
                  className="w-9 h-9 rounded-full bg-slate-800 text-slate-300 group-hover:bg-cyan-500 group-hover:text-slate-950 flex items-center justify-center transition-all"
        ...
        <div className="mt-12 p-8 rounded-3xl bg-gradient-to-r from-slate-900 via-cyan-950/30 to-slate-900 border border-cyan-500/30 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-1 text-center md:text-left">
            ...
            <p className="text-slate-300 text-sm">Let's discuss how I can help bring your AI or Web product to life.</p>
          </div>
          <a
            href="#contact"
