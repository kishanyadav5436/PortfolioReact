...
export default function Certifications() {
  ...
  return (
    <section id="certifications" className="py-24 relative bg-slate-950/70 border-t border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              <div className="space-y-2">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="font-code text-xs text-slate-400">{cert.date}</span>
                </div>
                ...
                <p className="font-code text-xs text-cyan-400 font-semibold">
                  Issuer: {cert.issuer}
                </p>
              </div>
        ...
        {/* Collapsible Workshops & Participation List */}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {certsWorkshops.map((w, idx) => (
                      <div key={idx} className="p-4 rounded-xl bg-slate-950/80 border border-slate-800/80 space-y-1">
                        ...
                        <div className="flex items-center justify-between text-xs font-code text-slate-400 pl-6">
                          <span>{w.issuer}</span>
