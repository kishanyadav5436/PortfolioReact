...
import { Briefcase, Calendar, MapPin, CheckCircle2, Trophy, Terminal } from 'lucide-react';
import { experience } from '../data/portfolioData';

export default function Experience() {
  return (
    <section id="experience" className="py-24 relative bg-slate-950/70 border-t border-slate-800/80">
        ...
        <div className="relative border-l-2 border-slate-800 ml-4 sm:ml-8 space-y-12">
          {experience.map((item, index) => (
            <div key={index} className="relative pl-6 sm:pl-10 group">
              ...
              <div className="p-6 sm:p-8 rounded-3xl bg-slate-900/90 border border-slate-800/90 group-hover:border-cyan-500/30 transition-all duration-300 shadow-xl space-y-4">
                ...
                <div className="flex flex-wrap items-start justify-between gap-2 border-b border-slate-800 pb-4">
                  <div>
                    ...
                    <div className="font-code text-xs text-cyan-400 font-semibold mt-0.5">
                      {item.company}
                    </div>
                  </div>

                  <div className="flex items-center gap-3 font-code text-xs text-slate-400">
                ...
                <div className="space-y-1.5 pt-2">
                  {item.highlights.map((h, idx) => (
                    <div key={idx} className="flex items-center gap-2 text-xs text-slate-300 font-sans font-medium">
