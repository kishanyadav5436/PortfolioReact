...
import { GraduationCap, Heart, Users, MapPin, Terminal } from 'lucide-react';
import { personalDetails, education, softSkills, interests } from '../data/portfolioData';

export default function About() {
  return (
    <section id="about" className="py-24 relative bg-slate-950/60 border-y border-slate-800">
          ...
          <div className="lg:col-span-7 rounded-3xl bg-slate-900/90 border border-slate-800 p-6 sm:p-8 space-y-6 shadow-xl">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-code text-xs text-cyan-300 flex items-center gap-1.5 font-medium">
            ...
            <div className="space-y-4 text-slate-200 text-sm sm:text-base leading-relaxed font-sans">
              <p>
                I'm a Computer Science student at <strong className="text-white">Babu Banarasi Das University, Lucknow</strong>, obsessed with constructing software systems that solve real human problems. My journey started with web design, grew into full-stack MERN engineering, and expanded into <strong className="text-cyan-300">AI/ML architectures — LangChain, Hugging Face, Scikit-Learn, and RAG pipelines</strong>.
              </p>
              <p>
            ...
            <div className="pt-4 border-t border-slate-800 grid grid-cols-2 gap-4">
              <div className="p-3.5 rounded-xl bg-slate-950/80 border border-slate-800">
                <div className="font-code text-xs text-slate-300 font-medium">Current Focus</div>
                <div className="font-bold text-sm text-cyan-300">RAG AI & Full-Stack MERN</div>
              </div>
              <div className="p-3.5 rounded-xl bg-slate-950/80 border border-slate-800">
                <div className="font-code text-xs text-slate-300 font-medium">Status</div>
              ...
              <div className="space-y-4">
                {education.map((edu, idx) => (
                  <div key={idx} className="relative pl-5 border-l-2 border-slate-800 space-y-1">
                    ...
                    <div className="text-xs text-slate-300 font-sans">{edu.institution}</div>
                    <div className="flex items-center justify-between text-[11px] font-code text-slate-300 font-medium pt-0.5">
                      <span>{edu.year}</span>
            ...
            <div className="rounded-3xl bg-slate-900/90 border border-slate-800 p-6 space-y-3 shadow-xl">
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                {softSkills.map((skill, idx) => (
                  <span
                    key={idx}
                    className="px-3 py-1 rounded-lg bg-slate-800/90 border border-slate-700/80 font-code text-xs text-slate-200 font-medium"
                  >
                    {skill}
                  </span>
                ))}
